...
public interface ConfigurationNodeSource {
	 ...
	 * Remember that this returns a DIRECT child, without splitting at the {@link com.alta189.cyborg.api.util.config.Configuration#getPathSeparator()}
	 *
	 ...
	 * include paths from child nodes, joined by {@link com.alta189.cyborg.api.util.config.Configuration#getPathSeparator()}
